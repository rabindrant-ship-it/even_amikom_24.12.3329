    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}"
                ...
                <svg class="w-5 h-5 {{ request()->routeIs('admin.dashboard') ? 'text-indigo-400' : 'text-indigo-300' }}"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">

                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2
                        2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0
                        012 2v2a2 2 0 01-2 2h-2a2 2 0
                        01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0
                        012 2v2a2 2 0 01-2 2H6a2 2 0
                        01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0
                        012 2v2a2 2 0 01-2 2h-2a2 2 0
                        01-2-2v-2z"></path>
                </svg>
            ...
            <a href="{{ route('admin.events.index') }}"
                ...
                <svg class="w-5 h-5 {{ request()->routeIs('admin.events.*') ? 'text-indigo-300' : 'text-indigo-400' }}"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        00-2-2H5a2 2 0 00-2 2v12a2 2 0
                        002 2z"></path>
                </svg>
    ...
    <main class="flex-1 p-10 overflow-y-auto w-full">
        ...
        <header class="flex justify-between items-center mb-10 w-full">
            ...
            <div class="flex items-center gap-4">
                ...
                <div
                    class="w-12 h-12 bg-white rounded-2xl shadow-sm border flex items-center justify-center p-1">
